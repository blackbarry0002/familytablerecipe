  ...
  head: () => ({
    meta: [
      { title: "About — Family Table Recipe" },
      {
        name: "description",
        content:
          "The story behind Family Table Recipe — a home for the meals that bring people together.",
      },
        ...
        <section className="mx-auto max-w-7xl pt-2">
          <Reveal className="relative overflow-hidden rounded-[2.5rem] bg-cream-deep p-8 sm:p-14">
            <img
              ...
              alt=""
              loading="lazy"
              className="absolute right-0 top-0 h-full w-1/2 object-cover opacity-45 hidden md:block"
            />
            ...
            <div className="relative max-w-2xl">
              ...
              <p className="mt-5 text-ink-soft max-w-lg">
                A modern recipe home built around one quiet belief — the meals that matter are the
                ones we share.
              </p>
            </div>
          </Reveal>
        ...
        <section className="mx-auto max-w-7xl mt-24 grid lg:grid-cols-[1fr_1.1fr] gap-10 items-center">
          ...
          <Reveal>
            ...
            <p className="mt-6 text-ink-soft leading-relaxed">
              Family Table began with a worn notebook full of grandmother's handwriting —
              measurements in pinches, instructions in stories. We started this site to keep that
              warmth alive in a modern kitchen: tested recipes, beautiful photography, and the quiet
              rituals that turn cooking into care.
            </p>
            <p className="mt-4 text-ink-soft leading-relaxed">
              Every recipe is cooked at least three times in our own homes before it gets a place at
              the table. We test for taste, for clarity, and for the small things — a friendly
              Tuesday meal, a slow Sunday roast, a dessert worth lighting candles for.
            </p>
          </Reveal>
        </section>
            ...
            <div className="relative overflow-hidden rounded-[2rem] lg:row-span-2 min-h-64">
              ...
              <div className="absolute inset-x-0 bottom-0 p-8">
                ...
                <h3 className="mt-2 font-display text-2xl sm:text-3xl font-bold text-cream">
                  Slow over fast, always.
                </h3>
                <p className="mt-3 text-sm text-cream/80 leading-relaxed">
                  We make room for the steps that matter, even on a Tuesday.
                </p>
              </div>
            </div>
            <ValueCard
              ...
              n="02"
              t="Seasonal & local"
              b="The best ingredients are the ones near you, right now."
            />
            <ValueCard
              image={pancakes}
              n="03"
              t="Recipes that work"
              b="Tested in our homes — measurements, timing and all."
            />
            <ValueCard
              image={chicken}
              n="04"
              t="Made for gathering"
              b="Every recipe is written for the people you cook with."
            />
            <ValueCard
              image={family}
              n="05"
              t="Stories, not lectures"
              b="A kitchen is a place to learn — gently, with each other."
            />
          </Reveal>
        </section>
        ...
        <section className="mx-auto max-w-7xl my-28">
          <Reveal className="relative overflow-hidden rounded-[2.5rem] bg-ink text-cream p-10 sm:p-16 text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <Link
                to="/contact"
                className="btn-ghost !bg-transparent !text-cream !border-cream/30 hover:!bg-white/10"
              >
                Get in touch
              </Link>
            </div>
