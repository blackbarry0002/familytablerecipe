  ...
  head: () => ({
    meta: [
      { title: "Contact — Family Table Recipe" },
      {
        name: "description",
        content:
          "Say hello to the Family Table team — share recipes, ask questions, or pitch a collaboration.",
      },
          ...
          <Reveal className="relative overflow-hidden rounded-[2.5rem] bg-cream-deep p-8 sm:p-14">
            ...
            <div className="relative max-w-2xl">
              ...
              <p className="mt-5 text-ink-soft max-w-lg">
                Share a recipe, ask a kitchen question, or pitch a collaboration — our table is
                open.
              </p>
            </div>
          </Reveal>
        ...
        <section className="mx-auto max-w-7xl mt-12 grid gap-6 lg:grid-cols-[1fr_1.3fr]">
          ...
          <Reveal className="card-floating p-8 sm:p-10">
            <p className="text-ink-soft leading-relaxed">
              Connect with the Family Table team. Whether you have a burning question about a
              recipe, want to share your kitchen story, or partner with us — we read every message.
            </p>
            <div className="mt-8 grid sm:grid-cols-2 gap-6">
              ...
              <Info
                icon={MapPin}
                label="Studio"
                value="123 Harvest Lane, Hudson, NY 12534"
